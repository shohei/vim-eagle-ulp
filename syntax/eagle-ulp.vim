...
syn keyword eagleULPFunc dlgMessageBox dlgHBoxLayout dlgRadioButton dlgStretch dlgGroup dlgPushButton dlgLabel dlgIntEdit dlgSpacing dlgDialog dlgVBoxLayout dlgComboBox dlgCheckBox board sch dlgTextView dlgTextEdit dlgAccept dlgReject
